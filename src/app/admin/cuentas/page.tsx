...
export default function Page() {
  return <SimpleCrud<Row> title="Cuentas" subtitle="Administradores, agentes y clientes." endpoint="/api/v1/users"
    fields={[{ name: "name", label: "Nombre", required: true, half: true }, { name: "email", label: "Correo", type: "email", required: true, half: true }, { name: "role", label: "Rol", type: "select", default: "AGENT", half: true, options: [{ value: "ADMIN", label: "Administrador" }, { value: "AGENT", label: "Agente" }, { value: "CUSTOMER", label: "Cliente" }] }, { name: "credits", label: "Créditos", type: "number", default: 0, half: true }, { name: "phone", label: "Teléfono", half: true }, { name: "password", label: "Contraseña", type: "password", half: true, hint: "Vacío = no cambiar (nuevo: Habitta123!)" }, { name: "avatarUrl", label: "Foto", type: "image" }, { name: "isActive", label: "Cuenta activa", type: "checkbox", default: true }]}
