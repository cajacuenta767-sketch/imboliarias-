...
/**
 * Imagen con marcador de reserva ante fallos. `priority` la marca como prioritaria (LCP: portada, hero)
 * en lugar de cargarla en diferido. Si no se indican dimensiones se usa 4:3 para reservar espacio y evitar saltos.
 */
export function SmartImage({ src, alt, className, priority, width, height, ...rest }: Omit<React.ImgHTMLAttributes<HTMLImageElement>, "src"> & { src?: string | null; priority?: boolean }) {
