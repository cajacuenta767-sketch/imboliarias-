...
export async function SiteFooter() {
  const [t, s, pages] = await Promise.all([getTranslations("footer"), getSettings(), listPages(true)]);
      ...
      <div className="container-x grid gap-10 py-14 md:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-ink-soft">
            <li><Link href="/propiedades?type=SALE" className="hover:text-brand">Comprar</Link></li>
            <li><Link href="/propiedades?type=RENT" className="hover:text-brand">Alquilar</Link></li>
            <li><Link href="/proyectos" className="hover:text-brand">Proyectos</Link></li>
            <li><Link href="/agentes" className="hover:text-brand">Agentes</Link></li>
            <li><Link href="/noticias" className="hover:text-brand">Noticias</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-ink-soft">
            ...
            <li><Link href="/empleos" className="hover:text-brand">Empleos</Link></li>
            <li><Link href="/contacto" className="hover:text-brand">Contacto</Link></li>
          </ul>
        </div>
        <div>
