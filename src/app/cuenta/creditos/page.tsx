...
import { creditHistory, listPackages } from "@/server/modules/billing/service";
...
const REASONS: Record<string, string> = { PACKAGE_PURCHASE: "Compra de paquete", PROPERTY_PUBLISH: "Publicación", PROPERTY_RENEW: "Renovación", ADMIN_ADJUST: "Ajuste" };
...
export default async function CreditsPage() {
  ...
  return (
    <div>
      ...
      <PackagesGrid packages={packages} taxPercent={Number(settings.tax_percent ?? 0)} />
